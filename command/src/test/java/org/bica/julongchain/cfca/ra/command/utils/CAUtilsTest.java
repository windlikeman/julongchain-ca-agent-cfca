...
public class CAUtilsTest {
     ...
     */
    static CertStore getStore(Collection col) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException {
    ...
    public void performTest() throws Exception {
        ...
        try {
            ...
            if (!e.getCause().getMessage().equals("CertPath for CRL signer failed to validate.")) {
                assertTrue("Exception thrown, but wrong one : " + e.getCause(), false);
            }
        }
    }
}