...
public class ReenrollmentRequestNet {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(request, that.request) && Objects.equals(profile, that.profile) && Objects.equals(label, that.label)
    ...
    static class Builder {
        // Required
        /**
         * A encoded string containing the CSR (Certificate Signing Request)
         * based on PKCS #10.
         */
        private final String request;
        /**
         * The username of the signing profile to use when issuing the
         * certificate.
         */
        private final String profile;
        /**
