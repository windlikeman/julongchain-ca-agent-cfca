...
public class RevokeRequestNet {
     ...
     * including both enrollment certificates and transaction certificates. All
     * future enrollment attempts for this identity will be rejected. If this
     * field is specified, the *serial* and *aki* fields are ignored.
     */
    ...
    /**
     * The serial number of the certificate which is to be revoked. The *aki*
     * (Authority Key Identifier) field must also be specified.
     */
    private final String serial;
    /**
     * The reason for revocation. The default value is 0 (ocsp.Unspecified).
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(aki, that.aki) && Objects.equals(serial, that.serial) && Objects.equals(reason, that.reason)
